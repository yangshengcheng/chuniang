        ...
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="category_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
              <td class="left"><select name="category_module[<?php echo $module_row; ?>][store_id]">
...
function addModule() {	
    ...
    html += '      <option value="0"><?php echo $text_disabled; ?></option>';
    html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="category_module[' + module_row + '][sort_order]" value="" size="3" /></td>';

    html += '    <td class="left"><select name="category_module[' + module_row + '][store_id]">';
		<?php foreach ($stores as $store) { ?>
