        ...
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="featured_module[<?php echo $module_row; ?>][title]" value="<?php echo $module['title']; ?>" size="5" /></td>
              ...
              <td class="left"><input type="text" name="featured_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" size="3" />
                ...
                <?php } ?></td>
              <!-- yangshengcheng@gmail.com -->
              <td class="left"><input type="text" name="featured_module[<?php echo $module_row; ?>][category]" value="<?php echo $module['category']; ?>" size="5" /></td>  
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><input type="text" name="featured_module[' + module_row + '][title]" value="热卖" size="5" /></td>';
	...
	html += '    <td class="left"><input type="text" name="featured_module[' + module_row + '][category]" value="" size="5" /></td>';
