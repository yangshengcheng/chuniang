...
class ControllerCheckoutGuest extends Controller {
  	public function index() {
		...
		if (isset($this->session->data['guest']['nickname'])) {
			$this->data['nickname'] = $this->session->data['guest']['nickname'];
		} else {
			$this->data['nickname'] = '';
		}
...
*/	
			...
			if ((utf8_strlen($this->request->post['address_1']) < 6) || (utf8_strlen($this->request->post['address_1']) > 128)) {
		...
		if (!$json) {
			...
			$this->session->data['guest']['nickname'] = $this->request->post['nickname'];
			//$this->session->data['guest']['email'] = $this->request->post['email'];
			$this->session->data['guest']['telephone'] = $this->request->post['telephone'];
			//$this->session->data['guest']['fax'] = $this->request->post['fax'];
			
			$this->session->data['guest']['payment']['nickname'] = $this->request->post['nickname'];
			...
			if ($this->session->data['guest']['shipping_address']) {
				$this->session->data['guest']['shipping']['nickname'] = $this->request->post['nickname'];
