...
class ControllerCheckoutRegister extends Controller {
  	public function index() {
		...
		//recommend text_entry_recommend
		...
		$this->data['button_cancle'] = $this->language->get('button_cancle');
...
//
	...
	public function validate() {
		...
		if (!$json) {					
			if ((utf8_strlen($this->request->post['nickname']) < 2) || (utf8_strlen($this->request->post['nickname']) > 32)) {
				$json['error']['nickname'] = $this->language->get('error_nickname');
			}
...
*/			
		...
		if (!$json) {
			//address  的 firstname 对应 customer 的 nickname
			$this->request->post['firstname'] = $this->request->post['nickname'];
			
			$this->model_account_customer->addCustomerWhileCheckout($this->request->post);
