	...
	private $error = array();
  	...
  	public function index() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
    		...
    		// add by yangshengcheng@gmail.com, 给推荐用户返点
			if($this->request->post['recommend'])
			{
				$recommend_telephone = $this->request->post['recommend'];
				//print $recommend_email;
				$this->model_account_customer->addRecommendCoupon($recommend_telephone,date('Y-m-d H:i:s',time()));
			}
			
			//$this->customer->login($this->request->post['email'], $this->request->post['password']);
			
			//add yangshengcheng@gmail.com  use telephone login 
...
//			}
		...
		$this->data['text_entry_recommend'] = $this->language->get('text_entry_recommend');
		$this->data['text_get_validate'] = $this->language->get('text_get_validate');
		...
		//add yangshengcheng@gmail.com
    	$this->data['entry_validate_code'] = $this->language->get('entry_validate_code');
    	...
    	//add yangshengcheng@gmail.com
 		if (isset($this->error['recommend'])) {
			$this->data['error_recommend'] = $this->error['recommend'];
		} else {
			$this->data['error_recommend'] = '';
		}
		...
		if (isset($this->error['validate_code'])) {
			$this->data['error_validate_code'] = $this->error['validate_code'];
		} else {
			$this->data['error_validate_code'] = '';
		}
		//end of yangshengcheng@gmail.com
		...
		*/
		...
		if (isset($this->request->post['email'])) {
			...
			$this->data['email'] = 'default@gmail.com';
		}
		...
		if (isset($this->request->post['telephone'])) {
			...
			$this->data['telephone'] = '';
				...
				//add Yangshengcheng@gmail.com
  		if (isset($this->request->post['validate_code'])) {
    		$this->data['validate_code'] = $this->request->post['validate_code'];
		} else {
			$this->data['validate_code'] = '';
		}
...
*/
    	...
    	// add yangshengcheng@gmail.com   use telephone as the uniqueness
		if ($this->model_account_customer->getCustomerByTelephone($this->request->post['telephone'])) {
      		$this->error['warning'] = $this->language->get('error_exists');
    	}
		...
		*/
		...
		if ($this->config->get('config_account_id')) {
  		...
  		// add yangshengcheng@gmail.com, 手机验证码校验
		if (preg_match_all('/^\d{6}$/',$this->request->post['validate_code'],$match)) 
		{
			$this->load->model('account/validate');
			if(! $this->model_account_validate->compValidate($this->request->post['telephone'],$this->request->post['validate_code'],time()))
			{
				$this->error['validate_code'] = $this->language->get('error_validate_code');
			}
    	}
    	else
    	{
