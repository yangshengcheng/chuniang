  ...
  <div class="box-content">
	...
	<dl id="idContainer2" class="container2">
		 <?php foreach ($categories as $category) { ?>
		 	<dd id="<?php echo $category['category_id']; ?>"><a target="_blank" href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></dd>
		 <?php } ?>
	</dl>
		...
		<dd id="idMenu2">
		 <?php foreach ($categories as $category) { ?>
		 	...
		 	<?php foreach ($category['children'] as $child) { ?>
		 		<div id="<?php echo $child['category_id']; ?>"><a target="_blank" href="<?php echo $child['href']; ?>"> - <?php echo $child['name']; ?></a></div>
		 	<?php } ?>
		 	<?php } ?>
		 <?php } ?>
		</dd>
...
FixedMenu.prototype = {
  ...
  del: function() {
	...
	this._iniMenu();
			...
			var menu2 = [
			<?php foreach ($categories as $category) { ?>
			{ id : "<?php echo $category['category_id']; ?>", parent : 0, elem: "<?php echo $category['category_id']; ?>" },
		 	<?php if ($category['children']) { ?>
		 	<?php foreach ($category['children'] as $child) { ?>
		 		{ id : "<?php echo $child['category_id']; ?>", parent : "<?php echo $category['category_id']; ?>", elem: "<?php echo $child['category_id']; ?>" },
		 	<?php } ?>
		 	<?php } ?>
		 	<?php } ?>			
			];
